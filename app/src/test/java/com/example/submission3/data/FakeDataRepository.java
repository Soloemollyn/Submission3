...
import com.example.submission3.data.source.DataSource;
import com.example.submission3.data.source.NetworkBoundResource;
...
public class FakeDataRepository implements DataSource {

    private final RemoteDataSource remoteDataSource;
    private final LocalDataSource localDataSource;
    private final AppExecutors appExecutors;

    FakeDataRepository(@NonNull RemoteDataSource remoteDataSource, @NonNull LocalDataSource localDataSource, AppExecutors appExecutors) {
    ...
    @Override
    public LiveData<Resource<TvShowEntity>> getDetailTvShow(String tvShowId) {
